...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            System.out.println("Aviso: Conflicto al sembrar Objetivo (ya existe): " + e.getMessage());
        }
        ...
        try {
            if (actividadRepo.count() == 0) {
                ...
                actividadRepo.saveAll(Arrays.asList(
                        ...
                        new NvActividad(5, "Muy intenso (Ejercicio diario intenso o trabajo físico)", 1.9f)));
            }
        } catch (Exception e) {
            System.out.println("Aviso: Conflicto al sembrar Nv_Actividad (ya existe): " + e.getMessage());
        }
        ...
        try {
            ...
            System.out.println("Aviso: Conflicto al sembrar TipoAlimentacion (ya existe): " + e.getMessage());
        }
        ...
        try {
            ...
            System.out.println("Aviso: Conflicto al sembrar ComidaRecomendada (ya existe): " + e.getMessage());
        }
